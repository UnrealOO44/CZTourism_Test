...
{for(var i = 0, len = gdjs.ComputerCode.GDAction_9595btnObjects2.length ;i < len;++i) {
    gdjs.ComputerCode.GDAction_9595btnObjects2[i].setX(((gdjs.evtTools.window.getWindowInnerWidth() - (((gdjs.ComputerCode.GDAction_9595btnObjects2[i].getWidth()) * runtimeScene.getGame().getVariables().getFromIndex(6).getAsNumber()) + 50)) / 2) + (((gdjs.ComputerCode.GDAction_9595btnObjects2[i].getWidth()) + 50) * gdjs.ComputerCode.GDAction_9595btnObjects2[i].getVariables().getFromIndex(0).getAsNumber()));
}
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("Button_text"), gdjs.ComputerCode.GDButton_9595textObjects2);
{for(var i = 0, len = gdjs.ComputerCode.GDAction_9595btnObjects2.length ;i < len;++i) {
    gdjs.ComputerCode.GDAction_9595btnObjects2[i].setX((gdjs.evtTools.window.getWindowInnerWidth() - (gdjs.ComputerCode.GDAction_9595btnObjects2[i].getWidth())) / 2);
}
}
{for(var i = 0, len = gdjs.ComputerCode.GDButton_9595textObjects2.length ;i < len;++i) {
    gdjs.ComputerCode.GDButton_9595textObjects2[i].setX((gdjs.evtTools.window.getWindowInnerWidth() - (gdjs.ComputerCode.GDButton_9595textObjects2[i].getWidth())) / 2);
}
}
{for(var i = 0, len = gdjs.ComputerCode.GDButton_9595textObjects2.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.ComputerCode.GDNotification_9595HeadObjects1.length ;i < len;++i) {
    gdjs.ComputerCode.GDNotification_9595HeadObjects1[i].setX((gdjs.evtTools.window.getWindowInnerWidth() - (gdjs.ComputerCode.GDNotification_9595HeadObjects1[i].getWidth())) / 2);
}
}
...
{for(var i = 0, len = gdjs.ComputerCode.GDNotification_9595textObjects1.length ;i < len;++i) {
    gdjs.ComputerCode.GDNotification_9595textObjects1[i].setX((gdjs.evtTools.window.getWindowInnerWidth() - (gdjs.ComputerCode.GDNotification_9595textObjects1[i].getWidth())) / 2);
}
}
{for(var i = 0, len = gdjs.ComputerCode.GDNotification_9595down_9595btnObjects1.length ;i < len;++i) {
